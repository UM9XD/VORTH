...
m.Parent = game.Players.LocalPlayer.Character 
...
torso = game.Players.LocalPlayer.Character:findFirstChild("HumanoidRootPart") 
they = 0 
...
hu.MaxHealth = math.huge floaty = Instance.new("BodyPosition") 
floaty.Parent = tor 
...
local a = game:GetService("InsertService"):LoadAsset(33495147) 
a.Parent = game.Workspace 
a:MoveTo(game.Workspace[vip.Name].Torso.Position) 
end 

if string.find(msg, "insert") then 
local g = game:GetService("InsertService"):LoadAsset(23391377) 
	...
	coroutine.resume(coroutine.create(function()
		while true do 
			...
			for i,v in pairs(M:GetChildren()) do 
				v:BreakJoints() 
				local n = tonumber(v.Name)*randomnes 
